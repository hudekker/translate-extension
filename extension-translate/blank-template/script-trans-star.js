...
const copyStarModal = (goto = "") => {
  ...
  // Close the modal and possibly Goto Chatgpt
  switch (goto) {
    case "":
      closeStarModal();
      break;
...
const sendMessageGotoChatgpt = () => {
  // Create a custom event
  const customEvent = new Event("gotoChatgpt");
